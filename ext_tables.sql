...
(
	...
	fe_users       varchar(2047) DEFAULT '' NOT NULL,
	fe_groups      varchar(2047) DEFAULT '' NOT NULL,
	be_users       varchar(2047) DEFAULT '' NOT NULL,
	be_groups      varchar(2047) DEFAULT '' NOT NULL,
